        ...
        while True:
            try:
                ...
                if not c.DISABLE_DEPTH_PROVIDER:
                    ...
                    depth_data = RealsenseCamera._decimate_depth_data(
                        depth_frame, full_depth_data
                    )
                ...
                traceback.print_exc()
                print(
                    "Failed to fetch frame from realsense camera. Waiting 5 seconds and retrying..."
                )
                time.sleep(5)
    ...
    def _decimate_numpy(depth_frame, depth_data):
        ...
        for x in range(target_width):
            ...
            for y in range(target_height):
                ...
                section = depth_data[
                    data_x : data_x + block_width, data_y : data_y + block_height
                ]
