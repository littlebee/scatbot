...
writer = cv2.VideoWriter(
    "camera_test_output.mp4", cv2.VideoWriter_fourcc(*"mp4v"), capture_fps, size
)
...
print(
    "   scp pi@raspberrypi.local:/home/pi/mi_corazon/camera_test_output.mp4 . && open camera_test_output.mp4"
)
